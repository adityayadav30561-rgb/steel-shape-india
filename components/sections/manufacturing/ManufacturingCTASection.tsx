      ...
      <Container>
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-6 mb-12 md:mb-20">
            ...
            <button className="flex items-center justify-center gap-3 bg-white text-black px-6 sm:px-10 py-4 sm:py-5 rounded-xl font-semibold shadow-lg transition-all duration-300 ease-out hover:scale-105 hover:-translate-y-1 active:scale-95 w-full sm:w-auto">
              <MessageSquare size={18} />
              Request Technical Discussion
            </button>

            <button className="flex items-center justify-center gap-3 bg-transparent border border-white/10 text-white px-6 sm:px-10 py-4 sm:py-5 rounded-xl font-semibold hover:bg-[#1a1c25] transition-all duration-300 ease-out hover:scale-105 hover:-translate-y-1 active:scale-95 w-full sm:w-auto">
              <Upload size={18} />
              Send Your Drawing
            </button>
